...
public class UpdateDomaine implements Initializable {
	...
	private void save(ActionEvent e) {
		...
		if (libelle.isBlank()) {
			...
			savedlabel.setText("Domaine successfully added ");
			clean();
	...
	private void getQuery() {
		...
		if (update == false) {
			...
			query = "UPDATE `domaine` SET " + "`Libelle`=? WHERE Code_domaine = '" + idfiled + "'";
		}
	...
	public void setTextField(int code_domaine, String libelle) {
		// TODO Auto-generated method stub
		idfiled = code_domaine;
